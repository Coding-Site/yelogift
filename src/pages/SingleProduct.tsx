        ...
        <div className="flex w-full sm:w-1/2 flex-col justify-start items-start gap-5">
          ...
          <div className="flex flex-col  gap-2 w-full">
            ...
            >
              ...
              <div className="flex justify-center items-center w-1/2">{q}</div>

              <button
                onClick={() => setQ((old) => (old > 1 ? --old : old))}
          ...
          <div className="flex justify-between w-full gap-3">
            <button className="btn grow !rounded-md basis-2/4" onClick={AddtoCart}>
              Add to cart
            </button>
