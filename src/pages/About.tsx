        ...
        <div className="flex flex-col items-center justify-center min-h-[40vh] bg-mainLightBlack p-6">
            <div className="bg-mainBlack shadow-md rounded-lg px-28 py-14 min-w-lg text-center max-w-[75%]">
                ...
                <section className="text-mainWhite mb-4">
                    ...
                    <p>
                        YELOGIFT is a project operated by individuals aimed at
                        providing high-quality digital cards that meet all your
                        needs. At YELOGIFT, we pride ourselves on being a
                        trusted source for digital cards.
                    </p>
                    <p>
                        We provide the easiest solution to purchase all digital
                        cards. With YELOGIFT, you can search for the best
                        products with ease, anytime and anywhere.
                    </p>
                </section>
                <section className="text-mainWhite mb-4">
                    <h2 className="text-2xl font-semibold mb-2 text-mainLightColor">
                    ...
                    <p>
                        ...
                        customers. We aim to provide a convenient and reliable
                        shopping experience, ensuring you get the best products
                ...
                <section className="text-mainWhite mb-4">
                    ...
                    <p>
                        ...
                        focusing on innovation and quality to continuously meet
                        our customers' expectations. YELOGIFT is committed to
                ...
                <section className="text-mainWhite mb-4">
                    ...
                    <ul className="list-none list-inside ">
                        ...
                        <li>
                            <span className="font-bold">Trust :</span> Building
                            strong relationships based on trust with our
                            customers at YELOGIFT.
                        </li>
                        <li>
                ...
                <section className="text-mainWhite">
                    ...
                    <p>
                        ...
                        solutions for purchasing digital cards, allowing you to
                        access the best deals anytime and anywhere. Our
