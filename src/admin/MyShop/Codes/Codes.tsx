...
function Codes() {
    ...
    const addNewCode = () => {
        ...
        instance
            .post('/api/admin/product/parts/codes/store', data, {
                headers: {
                    ...
                    <dialog id="my_modal_1" className="modal">
                        <div className="modal-box">
                            <div className="modal-action w-full">
                                ...
                                >
                                    <button className="btn btn-sm btn-circle !bg-transparent btn-ghost absolute right-2 top-2">
                                        ✕
                                    </button>
                                    <input
                                        type="text"
            ...
            <div className="flex flex-col gap-2 rounded-t-xl p-4  bg-white text-mainLightBlack">
                {loading ? (
                    ...
                    <form
                        ...
                        className="w-full flex flex-col gap-y-2 justify-center p-3 px-5 rounded-md"
                    >
                        ...
                        <input
                            ...
                            className="bg-transparent w-full outline-none border px-5 py-3 border-gray-500 rounded-md "
                        />
                        <button
                            type="submit"
                            className="ms-auto w-20 !h-12 flex items-center justify-center !rounded-md btn px-6"
                        >
                            Submit
                        </button>
                    </form>
