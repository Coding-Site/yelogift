...
function EditProduct() {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    instance.get(`/api/admin/product/${id}`, {
      headers: {
            ...
            <div className="w-full sm:w-1/2 flex flex-col gap-5">
              ...
              <div className="flex flex-col  gap-2 items-start">
                ...
                <div className="flex justify-between items-end gap-3 border border-gray-600 rounded-md bg-transparent p-3 w-full">
                  <label htmlFor="image" className="flex flex-col justify-end aspect-square border rounded-md cursor-pointer  border-dashed  border-gray-400 h-[150px]">
                    <img
